...
class Container:
    ...
    def __init__(self, id, typename, weight_limmit, length, width, height, boxes, spaceOptimizationFactor = 1, useDeepSearch= False, unitsOfMeasure = UnitsOfMeasure.Centimeter):
        ...
        self.weight_limmit = weight_limmit,
        self.TypeIndex = 0
    ...
    def getResultsJSON(self):
        ...
        data = {
            ...
            "dimensions": {
                ...
                "height": self.height,
                "ID": self.ID,
                "Weight_limmit": self.weight_limmit,
