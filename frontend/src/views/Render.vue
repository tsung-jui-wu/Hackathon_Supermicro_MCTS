<template>
  <div>
    ...
    <loading-dialog :dialogOpen="dialogOpen" />
    ...
    createSceneWithPallet() {
      ...
      for (const [index_of_container, container] of render_infos[
        ...
        for (const pallet of container["Fitted_items"]) {
          ...
          let new_xyz_array_of_current_pallet = rotationWithType(
            origin_xyz_array_of_current_pallet,
            pallet["RotationType"]
          );
          ...
          let pallet_instance = BABYLON.MeshBuilder.CreateBox(
            pallet_mesh_name,
            {
              width: pallet_x,
              height: pallet_y,
          ...
          pallet_instance.position.x =
            ...
            pallet["position_x"] +
            pallet_x / 2;
          pallet_instance.position.y = pallet_y / 2 + pallet["position_y"];
    ...
    this.axios({
      ...
      .then((response) => {
        ...
        try {
          ...
          //   footer:
          //     "<p>Do you create the box and container information first?</p>",
          // });
          // setTimeout(() => {
